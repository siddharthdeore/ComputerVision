...
int main()
{
   string cascadeName = "/home/ubuntu/Documents/data/haarcascades/haarcascade_profileface.xml";
   ...
   if(gpuCnt==0) return 0;  // no CUDA device found, quit
 
   if(!cascade_gpu.load(cascadeName))
     return 0;  // failed to load cascade file, quit
